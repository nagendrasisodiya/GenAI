from ibm_botocore.parsers import JSONParser
...
class AIResponse(BaseModel):
    summary: str =Field(description="summary of the users message")
...
llama3_template = PromptTemplate(
    ...
    {system_prompt}
    IMPORTANT: {format_prompt}<|eot_id|><|start_header_id|>user<|end_header_id|>
